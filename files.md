...
| `source.ts` | Source utilities: getSourceLabel (OC/CC/FD/CX labels), getSourceColorClass (themed badge colors for OpenCode/Claude Code/Factory Droid/Codex CLI with purple for codex-cli) |
