...
| File | Description |
|------|-------------|
| `Login.tsx` | Login page with WorkOS AuthKit integration, privacy messaging, getting started section with plugin links, tan mode theme support with footer theme switcher, GitHub icon link, updated mockup with view tabs and OC/CC source badges, feature list with Sync/Search/Private/Tag/Export/Delete keywords and eval datasets tagline |
